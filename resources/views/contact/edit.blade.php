...
<div class="card-body h-body">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{url('contact/'.$res->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control form-control-sm" value="{{ old('mobile')??$res->mobile }}" placeholder="Enter Mobile" name="mobile">
                        @error('mobile')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
